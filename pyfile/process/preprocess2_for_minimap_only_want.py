...
def get_directory_path_in_list(path_list):
    ...
    for path in path_list:
        folder_paths = get_directory_path(path)
        for folder_path in folder_paths:
            folder_name = folder_path.name
            serial_num = int(folder_name.split('_')[0])
            if serial_num in serial_nums_to_process:
    ...
    for i in range(len(directory_list)):
        ...
        for j in range(len(data_list)):
            try:
                ...
                createDirectory(f'/home/minkyoon/2023_crohn_data/processed_data5/{index_num}')
                np.save(f'/home/minkyoon/2023_crohn_data/processed_data5/{index_num}/{inorder_num}.npy', norm_img)
                norm_img
...
if __name__ == "__main__":
    ...
    # list of serial numbers you want to preprocess
    serial_nums_to_process = [
    4, 22, 23, 33, 39, 80, 107, 110, 158, 166, 167, 187, 195, 210,
    279, 281, 284, 293, 309, 335, 340, 385, 390, 391, 424, 425, 430,
    461, 466, 473, 511, 519, 526, 533, 553, 556, 584, 601, 620, 658,
    681, 691, 723, 773, 807, 828, 840, 949, 952, 953, 980, 994, 1008, 1028
    ]
