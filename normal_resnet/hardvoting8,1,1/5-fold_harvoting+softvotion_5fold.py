...
for i in range(10):
    ...
    model_path = f"/home/minkyoon/crohn/normal_resnet/stratifie_10fold_8,11/fold{fold_num}_resnet50_pi.pt"
    model_image = ResNet()
    ...
    # DataLoader
    dataset = CustomImageDataset(f"/home/minkyoon/crohn/csv/normal_resnet/10fold_staratified_8,1,1/test_fold_{fold_num}.csv", transform_valid)
    ...
    # 실제 라벨을 데이터에서 가져오기
    real_labels = {}
    data_csv = pd.read_csv(f"/home/minkyoon/crohn/csv/normal_resnet/10fold_staratified_8,1,1/test_fold_{fold_num}.csv")
