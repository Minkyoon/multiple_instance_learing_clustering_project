...
def freeze_model_until(model, layer_name):
    flag = True
...
# Layer2까지 잠근 모델 만들기
model = freeze_model_until(model, 'layer2')
...
for fold_num in range(1):
    ...
    fold=f'clamclambock_{fold_num}'
    train_path = f"/home/minkyoon/crohn/csv/end_to_end/remission/clam_similiar/train_data.csv"
    valid_path = f"/home/minkyoon/crohn/csv/end_to_end/remission/clam_similiar/valid_data.csv"
    test_path = f"/home/minkyoon/crohn/csv/end_to_end/remission/clam_similiar/test_data.csv"
