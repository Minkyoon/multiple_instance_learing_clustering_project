...
def plot_roc_curve(result_files, color, label):
    ...
    plt.plot(mean_fpr, mean_tpr, color=color, label=f'{label} (AUC = {round(mean_auc, 2)})')
...
for i in range(10):
    name1=f'/home/minkyoon/CLAM2/results/update_multihead7_add_911_230823_forpaper/remission_multimodal_stratified_721_s1/split_{i}_results.pkl'
...
plot_roc_curve(result_files_1, 'b', 'multimodal')
