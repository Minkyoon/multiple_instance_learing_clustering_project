...
# CLAM 모델 정의 및 가중치 로드
model = CLAM_SB()
state_dict = torch.load('/home/minkyoon/first/CLAM/results/relapse_downsampling/task_1_tumor_vs_normal_CLAM_50_s1/s_0_checkpoint.pt')
...
output_directory = '/home/minkyoon/crohn/csv/clam/relapse/downsampling/clam_vecotr_512/fold0'
